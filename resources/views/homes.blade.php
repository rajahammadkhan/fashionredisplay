                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-categories-box">
                            <img src="{{url('')}}/assets/img/categories/img1.jpg" alt="image">

                            <div class="content text-white">
                                <h3>Thrift Collection</h3>
                                <span>Shop pre-loved garments in <br> our thrift collection</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-categories-box">
                            <img src="{{url('')}}/assets/img/categories/img2.jpg" alt="image">

                            <div class="content">
                                <h3>Retro collections</h3>
                                <span>Recreate the past with our <br> retro collection</span>
                                <a href="#" class="default-btn">Shop Now</a>
                            </div>
                            <a href="#" class="link-btn"></a>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-categories-box">
                            <img src="{{url('')}}/assets/img/categories/img3.jpg" alt="image">

                            <div class="content">
                                <h3>Vintage collections</h3>
                                <span>Own iconic limited grails in <br> our vintage collection</span>
                                <a href="#" class="default-btn">Shop Now</a>
                            </div>
                            <a href="#" class="link-btn"></a>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-categories-box">
                            <img src="{{url('')}}/assets/img/categories/img4.jpg" alt="image">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <div class="offer-content">
                            ...
                            <a href="products-one-row.html" class="default-btn">Shop Now</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="sidebar-new-in-store">
                            ...
                            <ul class="products-list">
                                <li>
                                    <a href="#"><img src="{{url('')}}/assets/img/products/img1.jpg" alt="image"></a>
                                </li>

                                <li>
                                    <a href="#"><img src="{{url('')}}/assets/img/products/img2.jpg" alt="image"></a>
                                </li>

                                <li>
                                    <a href="#"><img src="{{url('')}}/assets/img/products/img3.jpg" alt="image"></a>
                                </li>

                                <li>
                                    <a href="#"><img src="{{url('')}}/assets/img/products/img4.jpg" alt="image"></a>
                                </li>
                            </ul>
                ...
                <div class="modal-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <div class="products-image">
                                <img src="{{url('')}}/assets/img/quick-view-img.jpg" alt="image">
                            </div>
                        </div>
                        ...
                        <div class="woocommerce-widget-area">
                            ...
                            <div class="woocommerce-widget aside-trending-widget">
                                <div class="aside-trending-products">
                                    <img src="{{url('')}}/assets/img/offer-bg.jpg" alt="image">
